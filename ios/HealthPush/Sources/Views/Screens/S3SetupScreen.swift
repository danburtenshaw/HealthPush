...
/// Configuration screen for setting up an Amazon S3 destination.
///
/// Provides fields for bucket name, region, access keys, path prefix,
...
struct S3SetupScreen: View {
    ...
    @State private var name = "Amazon S3"
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(isEditing ? "Edit Destination" : "Add Amazon S3")
    ...
    private var connectionSection: some View {
        Section {
            ...
            if let error = HealthDataExporter.validateBucketName(bucketName), !bucketName.isEmpty {
                ...
                Text("The S3 bucket where health data will be stored.")
            }
        }
    }
    ...
    private var authenticationSection: some View {
        Section {
            ...
            Text("IAM credentials with s3:GetObject and s3:PutObject permissions on the bucket.")
        }
    }
    ...
    private var testConnectionSection: some View {
        Section {
            ...
            .disabled(isTesting || bucketName.isEmpty || accessKeyID.isEmpty || secretAccessKey.isEmpty)
        }
    }
